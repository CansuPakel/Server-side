                ...
                <div class="col-lg-12">
                    <div class="bradcaump__inner text-center">
                        ...
                        <nav class="bradcaump-content">
                            ...
                            <a class="breadcrumb_item" href="{{url('/')}}">Shop</a>
                            <span class="brd-separetor">/</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="wn__fotorama__wrapper">
                                    ...
                                    @foreach($products->image->each->collection as $image)
                                        <a href=""> <img src="{{ asset('storage/images/'.$image->path)}}" alt="product image"> </a>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product__info__main">
                                    ...
                                    <div class="box-tocart d-flex">
                                        <div class="addtocart__actions">
                                            <form action="{{url('/addToCart/'.$products->id) }}" method="GET">
                                                @csrf
                        ...
                        <div class="tab__container">
                            ...
                            <div class="pro__tab_label tab-pane fade" id="nav-review" role="tabpanel">
                                <div class="review__attribute">
                                    <h1>Customer Reviews(Werkt niet)</h1>
                                    <h2>Hastech</h2>
